...
def main(argv=None):
	...
	program_shortdesc = "Source Code Advisor (SCA) -- Highlight potential problems in your source code and offer suggested solutions."
	program_license = '''%s
...
''' % (program_shortdesc)
	...
	try:
		...
		parser.add_argument("-v", "--verbose", dest="verbose", type=int, choices=range(0, 4), required=False, default=0, help="set verbosity level [default: %(default)s]")
		parser.add_argument("-o", "--optimize", dest="opt", type=int, choices=range(1, 5), required=False, default=3, help="set optimization level [default: %(default)s]")
